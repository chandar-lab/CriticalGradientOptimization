...
class Item:
    ...
    def hash_key(self):
        return (str(self.premise) + str(self.hypothesis) + str(self.correct) + str(
            self.label) + str(self.test))
    ...
    def diff(self, other):
        if not (Sentence.diff(self.premise, other.premise) == []): return (
            Sentence.diff(self.premise, other.premise), "premise")
        if not (Sentence.diff(self.hypothesis, other.hypothesis) == []): return (
            Sentence.diff(self.hypothesis, other.hypothesis), "hypothesis")
    ...
    def csv(self):
        str(self.premise) + "," + str(self.hypothesis) + "," + str(
            self.correct) + "," + str(self.label) + "," + str(
            self.test)
